...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/home/hfle/Website_GetResults/CAST_pytorch-main/datasets/object_count', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
